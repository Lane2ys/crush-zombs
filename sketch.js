...
function setup() {
  ...
  leftWall = new Base( 400, height / 2 + 50, 900, 100, "#8d6e63", true);
  rightWall = new Base(1900, height / 2 + 50, 600, 100, "#8d6e63", true);

  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  bridge = new Bridge(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base( 1600, height / 2 + 10, 40, 20, "#8d6e63", true);
